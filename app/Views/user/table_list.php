                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="<?= base_url('user/create') ?>" class="btn btn-bg btn-outline-success">Add New User</a>
                                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr id="<?= $users['user_id'] ?>">
                                                ...
                                                <td><?= ($users['status'] == 1) ? '<span class="badge rounded-pill bg-success">Active</span>' : '<span class="badge rounded-pill bg-dark">Inctive</span>' ?></td>
                                                <td>
                                                    <a href="<?= base_url('user/edit/'.$users['user_id']) ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
