                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p class="mb-5">Please enter the 4 digit code sent to <span class="fw-bold">your email</span></p>
                    
                                                <form action="<?= base_url('login/authorize') ?>" method="post">
                                                    <div class="row">
                                                        <div class="col-13">
                                                            <div class="mb-12">
                                                                <input type="text" name="code" class="form-control form-control-lg text-center two-step">
                                                                <input type="hidden" name="user_id" class="form-control form-control-lg text-center two-step" value="<?= $user_id ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
