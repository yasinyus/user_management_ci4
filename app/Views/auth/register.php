                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Create your account now.</p>
                                        </div>
                                        <form class="" action="<?= base_url('register/create_action') ?>" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="account_name" class="form-control"  placeholder="Account name" value="" required>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Already registered ? <a href="<?= base_url('login') ?>"> Login here</a> </p>
                                        </div>
                                    </div>
